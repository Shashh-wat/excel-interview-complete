...
class MurfAPIClient:
    """Complete Murf API client with full functionality"""
    ...
    async def text_to_speech(self, text: str, voice_id: str = None) -> Dict[str, Any]:
        """Generate speech with comprehensive error handling and URL generation"""
                        ...
                        if "audioFile" in response_data:
                            ...
                            if local_audio_path:
                                ...
                                return {
                                    ...
                                    "murf_response_id": response_data.get("id"),
                                    "generation_time": response_data.get("processingTime", "unknown")
                                }
                            else:
    ...
    async def _download_audio(self, audio_url: str) -> str:
        """Download audio file and store locally with proper naming"""
    ...
    def get_default_voices(self) -> List[Dict[str, str]]:
        ...
        return [
            {"id": "en-US-sarah", "name": "Sarah", "language": "English (US)", "gender": "Female", "description": "Professional, clear"},
            {"id": "en-US-john", "name": "John", "language": "English (US)", "gender": "Male", "description": "Authoritative, friendly"},
            {"id": "en-US-emma", "name": "Emma", "language": "English (US)", "gender": "Female", "description": "Warm, engaging"},
            {"id": "en-US-mike", "name": "Mike", "language": "English (US)", "gender": "Male", "description": "Casual, approachable"},
            {"id": "en-GB-oliver", "name": "Oliver", "language": "English (UK)", "gender": "Male", "description": "Sophisticated, British"},
            {"id": "en-GB-sophia", "name": "Sophia", "language": "English (UK)", "gender": "Female", "description": "Elegant, British"},
        ]
